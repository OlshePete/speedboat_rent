...
export default function MoneyTable({index=3}) {
  return(
    ...
    >
             <Typography variant="caption" align="right"> Список заказов</Typography>
      {
        data.map((el,index)=>{
          return(
            <Card
            ...
            >
              <Box sx={{p:1}}>
                <Box xs={{display:'flex',flexDirection:'column', justifyContent:'center'}}>
             <Typography variant="caption"> {el.customer_phone}</Typography>
